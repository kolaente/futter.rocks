<nav x-data="{ open: false }" class="print:hidden">
                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-semibold rounded-md text-gray-500 bg-transparent hover:bg-primary-light hover:text-white active:text-white focus:text-white focus:outline-none focus:bg-primary active:bg-primary transition ease-in-out duration-150">
