<div>
    ...
    <x-dialog-modal wire:model.live="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            <x-button variant="secondary" wire:click="$set('managingApiTokenPermissions', false)" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-button>
    ...
    <x-confirmation-modal wire:model.live="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            <x-button variant="secondary" wire:click="$toggle('confirmingApiTokenDeletion')" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-button>
